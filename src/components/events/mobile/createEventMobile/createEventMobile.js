...
// import './1eventDetailsMobile.css'
...
export default connect(mapStateToProps, mapDispatchToProps)(function createEventMobile(props) {
    ...
    return (
        <>
                ...
                <div className="container-fluid mobileDetailsEvent">
                    <div className="row mobileEventDetailsHeader createEventMobileHeader">
                        ...
                        <span className="mobileEventDetaileName createEventMobileDetaileName">'Create New Event'</span>
                    </div>
                    <div className="row mobileEventImageDiv">
                        <img className="mobileEventImage" src={events[index].image}></img>
                    </div>
                    <div className="row">
                        <h1 className="mobileEventTitle">'הכנס שם'</h1>
                    </div>
                    {/* <div className="row">
